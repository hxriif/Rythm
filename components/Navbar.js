...
const Navbar = () => {
    ...
    return (
        <div className='h-screen'>
            <div className='flex flex-col md:flex-row justify-between p-5 bg-[#121212]  w-[55rem] mt-3 rounded-lg  '>
            ...
            <div className='bg-[#121212] h-screen overflow-y-auto max-h-[400px]'>
            </div>
        </div>
    );
};
